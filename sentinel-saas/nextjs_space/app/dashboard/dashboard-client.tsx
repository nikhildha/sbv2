        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-cyan-400">Synaptic Bots · <span style={{ fontSize: '14px', color: '#9CA3AF' }}>${liveStats.totalCapitalDeployed}<span style={{ color: '#4B5563' }}>/{MAX_CAPITAL > 0 ? `$${MAX_CAPITAL}` : '—'}</span> active</span></h2>
              <Link
                href="/bots"
